    ...
    <div className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(217,166,104,0.24),_transparent_35%),linear-gradient(135deg,#1d120d_0%,#3e2b21_45%,#744e38_100%)] px-4 py-12">
      <div className="w-full max-w-md overflow-hidden rounded-[32px] border border-white/10 bg-white/90 shadow-[0_30px_80px_rgba(17,9,7,0.35)] backdrop-blur-sm">
        <div className="bg-[#1d120d] px-8 pb-8 pt-10 text-center text-white">
          ...
          <p className="mt-2 text-sm text-[#d8c5b6]">Create a secure password</p>
        </div>

        <div className="px-8 py-8">
          {done ? (
            <div className="text-center">
              <p className="text-lg font-semibold text-[#2a1d17]">Password updated successfully.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label htmlFor="password" className="mb-1 block text-sm font-medium text-[#2a1d17]">New password</label>
                <input
                  id="password"
                  type="password"
                  value={password}
              ...
              <div>
                <label htmlFor="confirmPassword" className="mb-1 block text-sm font-medium text-[#2a1d17]">Confirm password</label>
                <input
                  id="confirmPassword"
                  type="password"
